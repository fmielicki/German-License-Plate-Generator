...
public class PlateGenerator {
    ...
    public static void main(String[] args) {
        System.out.println(GenerateCity() + "-" + GenerateUniqueIdentifier() + " " + EndNumber());
    ...
    public static String GenerateCity() {
        ...
        int counter = (int) (long)Math.round(Math.random() * cityIdentifier.length);

        String city = cityIdentifier[counter - 1];
        return city;
    }
    ...
    public static String GenerateUniqueIdentifier() {
        ...
        while(i < 2) {
            int counter = (int) (long) Math.round(Math.random() * alphabet.length);
            identifier += alphabet[counter - 1];
            i++;
        }
